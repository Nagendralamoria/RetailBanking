...
public class AccountErrorTest {
	...
	CustomerAccountErrorResponse re=new CustomerAccountErrorResponse();
	CustomerAccountErrorResponse re1=new CustomerAccountErrorResponse(null,null,"invalid login","invalid");
