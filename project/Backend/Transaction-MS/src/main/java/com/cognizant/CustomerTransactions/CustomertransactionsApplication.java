package com.cognizant.CustomerTransactions;
...
public class CustomertransactionsApplication {
	...
	public static void main(String[] args) {
		log.info("CustomerTransactionApplication is started");
	...
	public Docket swaggerConfiguration() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.cognizant.CustomerTransactions.controller")).build()
				.apiInfo(apiInfo());
