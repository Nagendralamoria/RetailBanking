...
import com.cognizant.CustomerTransactions.service.CustomerTransactionServiceInterface;
...
@Slf4j
@CrossOrigin()
public class CustomerTransactionRestController {


	
	@Autowired
	CustomerAccountFeign custaccFeign;

	@Autowired
	RulesFeign rulesFeign;

	@Autowired
	CustomerTransactionRepository transRepo;
